          ...
          <div className="pt-12 sm:pt-16 lg:pt-20">
            ...
            {!show_cta ? '' :
              app_cta ? (<div className="mt-10 flex items-center justify-start gap-x-6">
                ...
                >
                  <Image src={google_store.url as any} alt='google app store badge' width={202} height={60} />
                </PrismicNextLink>
                <PrismicNextLink field={apple_store as any}
                >
                  <Image src={apple_app.url as any} alt=' apple app store badge'
                    width={180} height={60} />
                </PrismicNextLink>
